        ...
        <li class="card">
            <div class="grid-blak">
                <a href="<?= site_url('clientes') ?>">
                    <div class="numbers">Técnicos / Auxiliares</div>
        ...
        <li class="card">
            <div class="grid-blak">
                <a href="<?= site_url('produtos') ?>">
                    <div class="numbers">Materiais</div>
                ...
                <div class="new-bottons">
                    ...
                    <a href="<?php echo base_url(); ?>index.php/produtos/adicionar" class="card tip-top" title="Adicionar Produtos">
                        ...
                        <div>
                            ...
                            <div class="cardName">Materiais</div>
                        </div>
                    </a>
...
<div class="span12A" style="margin-left: 0">
    ...
    <div class="AAA">
        <div class="widget-box0 widbox-blak">
            <div>
                <h5 class="cardHeader">Materiais Com Estoque Mínimo</h5>
            </div>
            <div class="widget-content">
                <table class="table table-bordered">
                    <thead>
                    ...
                    <tbody>
                        ...
                        <?php else : ?>
                            <tr>
                                <td colspan="6">Nenhum material com estoque baixo.</td>
                            </tr>
                        <?php endif ?>
                    </tbody>
                </table>
