            ...
            <div class="widget-box" style="min-height: 200px">
                ...
                <div class="widget-content nopadding tab-content">
                    <table class="table table-bordered ">
                        ...
                        <?php
                        if ($produtos == null) {
                            echo '<tr><td colspan="4">Nenhum material foi encontrado.</td></tr>';
                        }
                        foreach ($produtos as $r) {
                            ...
                            if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eProduto')) {
                                echo '<a href="' . base_url() . 'index.php/produtos/editar/' . $r->idProdutos . '" class="btn-nwe3" title="Editar material"><i class="bx bx-edit"></i></a>';
                            }
                            echo '</td>';
                            echo '</tr>';
                        } ?>
