            ...
            <div class="widget-content nopadding tab-content">
                <div class="span12" id="divProdutosServicos" style=" margin-left: 0">
                    <ul class="nav nav-tabs">
                        ...
                        <li id="tabProdutos"><a href="#tab3" data-toggle="tab">Materiais</a></li>
                            ...
                            <div class="span12" id="divCadastrarOs">
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    <div class="span6" style="padding: 1%; margin-left: 0">
                                        <label for="descricaoProduto"><h4>Descrição Material/Serviço</h4></label>
                            ...
                            <div class="span12 well" style="padding: 1%; margin-left: 0">
                                <form id="formProdutos" action="<?php echo base_url() ?>index.php/os/adicionarProduto" method="post">
                                    <div class="span6">
                                        ...
                                        <input type="text" class="span12" name="produto" id="produto" placeholder="Digite o nome do material" />
                                    </div>
                                    <div class="span2">
                                    ...
                                    <table width="100%" class="table table-bordered" id="tblProdutos">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($produtos as $p) {
                                                ...
                                                echo (strtolower($result->status) != "cancelado") ? '<td><div align="center"><a href="" idAcao="' . $p->idProdutos_os . '" prodAcao="' . $p->idProdutos . '" quantAcao="' . $p->quantidade . '" title="Excluir Material" class="btn-nwe4"><i class="bx bx-trash-alt"></i></a></td>' : '<td></td>';
            ...
            submitHandler: function (form) {
                ...
                if (qtdTotalProdutosServicos <= 0) {
                    Swal.fire({
                        type: "error",
                        title: "Atenção",
                        text: "Não é possível faturar uma OS sem serviços e/ou materiais"
                    });
                        ...
                        success: function (data) {
                            if (data.result == true) {
                                ...
                                Swal.fire({
                                    type: "error",
                                    title: "Atenção",
                                    text: "Ocorreu um erro ao tentar adicionar material."
                                });
                            }
                        }
                    });
                    ...
                    success: function (data) {
                        if (data.result == true) {
                            ...
                            Swal.fire({
                                type: "error",
                                title: "Atenção",
                                text: "Ocorreu um erro ao tentar excluir material."
                            });
                        }
                    }
                });
